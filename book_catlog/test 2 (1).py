...
def signin():
    ...
    if signinsuccess:
        ...
        def add():
            ...
            screen.img = PhotoImage(file='E:\\dbms lab\\kamal\\Login.png')
...
##########################################################
        ...
        background_img = PhotoImage(file="E:\\dbms lab\\kamal\\background1.png")
        background = Label(frame, image=background_img, bg="#ffffff")
        background.pack()
        count=main.dbgetrank(cursor,username)
        if count>=5 and count<10:
            rank_img = PhotoImage(file="E:\\dbms lab\\kamal\\silver.png")   
        elif count>=10:
            rank_img = PhotoImage(file="E:\\dbms lab\\kamal\\gold.png")
        else:
            rank_img = PhotoImage(file="E:\\dbms lab\\kamal\\bronze.png")
        ...
        img3 = PhotoImage(file="E:\\dbms lab\\kamal\\img3.png")
...
img = PhotoImage(file='E:\\dbms lab\\kamal\\Login.png')
